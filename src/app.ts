...
// Note to self -- GT --
// Cookie_Secret and PostgresStore isn't working when npm run compile, can however start + test
// regardless however.
export function createApp(): Express {
  ...
  app.post('/characters/:id/statmethod', characterController.pickStat);
  app.post('/characters/:id/pointbuy', characterController.pointBuy);
  app.post('/characters/:id/rolling', characterController.rolling);
